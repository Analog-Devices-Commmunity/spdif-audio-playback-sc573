...
/* For ADSP-SC589, default CGU0 settings done in init_code are used (CCLK: 450 MHz and SYSCLK: 225 MHz).
* If you are building for a processor that is certified to run at 500MHz, and wish to set the core clock speed to 500MHz,
* you can generate a new pre-load file by simply defining the macro "CLOCK_SPEED_500MHZ" in "sc589_preload_Core0" project.
